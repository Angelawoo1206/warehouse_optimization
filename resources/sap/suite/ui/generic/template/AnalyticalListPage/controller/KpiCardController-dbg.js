        ...
        */
        ...
        onBeforeRendering: function() {
            ...
            if (!vizFrame) {
                ...
                var sTitleMeasure = KpiUtil.getPathOrPrimitiveValue(oModel, oChart.Title);
                if (oDataPointMeasure && oDataPointMeasure.ValueFormat && oDataPointMeasure.ValueFormat.ScaleFactor) {
                    iScaleFactorMeasure = KpiUtil.getPathOrPrimitiveValue(oModel, oDataPointMeasure.ValueFormat.ScaleFactor);
                }
