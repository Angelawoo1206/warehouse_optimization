...
], function(Control, Label, NumericContent, JSONModel, KpiTagController, KpiUtil) {
	"use strict";
	/**
	...
	return Control.extend("sap.suite.ui.generic.template.AnalyticalListPage.control.KpiTag", {
		...
		_setScaleInformation: function(oDataPoint) {
			if ( oDataPoint.ValueFormat ) {
				if ( oDataPoint.ValueFormat.ScaleFactor ) {
					this.setProperty("scale", KpiUtil.getPathOrPrimitiveValue(this._getDataModel(), oDataPoint.ValueFormat.ScaleFactor));
				}
			}
		},
		...
		*/
		...
		_calculateKPICriticality: function(oDataPoint) {
			var sImproveDirection = oDataPoint.CriticalityCalculation && oDataPoint.CriticalityCalculation.ImprovementDirection ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.CriticalityCalculation.ImprovementDirection) : undefined;
			var criticality = oDataPoint.Criticality ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.Criticality) : undefined;
			...
			var deviationLow = oDataPoint.CriticalityCalculation.DeviationRangeLowValue ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.CriticalityCalculation.DeviationRangeLowValue) : undefined;
			var deviationHigh = oDataPoint.CriticalityCalculation.DeviationRangeHighValue ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.CriticalityCalculation.DeviationRangeHighValue) : undefined;
			var toleranceLow = oDataPoint.CriticalityCalculation.ToleranceRangeLowValue ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.CriticalityCalculation.ToleranceRangeLowValue) : undefined;
			var toleranceHigh = oDataPoint.CriticalityCalculation.ToleranceRangeHighValue ? KpiUtil.getPathOrPrimitiveValue(this._getDataModel(),oDataPoint.CriticalityCalculation.ToleranceRangeHighValue) : undefined;
