...
sap.suite.ui.commons.ProcessFlow.NodeElement._updateLanesFromNodes = function (processFlowLanes, internalNodes) {
  ...
  for (var i = 0; i < internalNodes.length; i++) {
    ...
    for (var j = 0; j < oCurrentNodeChildren.length; j++) { // Check the children.
      ...
      var oNodeChildren = oNode[iChildId];
      if (oNodeChildren && (oCurrentNode.getLaneId() == oNodeChildren.getLaneId())) {
        // Create new lane id and check the lane.
        iNewLaneId = oNodeChildren.getLaneId() + iPositionUp;
        ...
        oNodeChildren._setMergedLaneId(oNewLane.getLaneId());
      }
      ...
      // This is a recursion.
      sap.suite.ui.commons.ProcessFlow.NodeElement._changeLaneOfChildren(oCurrentNode.getLaneId(), oNodeChildren, oNode);
    }
