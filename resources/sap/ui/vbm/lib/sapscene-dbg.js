...
// map zoom occured.......................................................//
	...
	scene.AnimationStep = function() {
		...
		if (scene.m_AnimZoomRequestID) {
			...
			scene.m_AnimZoomRequestID = undefined;
		}
	...
	scene.AnimateZoom = function(zoomIn, clientX, clientY, interval, event) {
		...
		if (scene.AnimZoomTimestamp && (Date.now() - scene.AnimZoomTimestamp) < 100) {
			return;
		}
		...
		scene.AnimZoomTarget = (scene.AnimZoomTarget ? scene.AnimZoomTarget : scene.AnimZoomOrigin) + (zoomIn ? 1 : -1);
