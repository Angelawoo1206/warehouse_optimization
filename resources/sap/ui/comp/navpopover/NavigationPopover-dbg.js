...
sap.ui.define([
	...
	NavigationPopover.prototype._syncAvailableAction = function(oLinkData) {
		...
		if (oModel.getProperty("/availableActionsPersonalizationText") !== undefined) {
			...
			oModel.setProperty("/availableActionsPersonalizationText", aMAvailableActionsVisible.length > -1 ? sap.ui.getCore().getLibraryResourceBundle("sap.ui.comp").getText("POPOVER_DEFINE_MORE_LINKS") : sap.ui.getCore().getLibraryResourceBundle("sap.ui.comp").getText("POPOVER_DEFINE_LINKS"));
		}
	};
