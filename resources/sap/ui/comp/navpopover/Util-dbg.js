...
sap.ui.define([
	...
	var Util = {
		...
		availableAction2MItems: function(oNavigationPopover) {
			return oNavigationPopover.getAvailableActions().filter(function(oAvailableAction) {
				...
				return oAvailableAction.getKey() !== undefined;
			}).map(function(oAvailableAction) {
				var oJson = oAvailableAction.getJson();
				oJson.visible = undefined;
				return oJson;
			});
		},
