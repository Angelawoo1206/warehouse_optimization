...
sap.ui.define([
					...
					if (vdslSources.has(source)) {
						...
						if (content.trim().length === 0) {
							...
							sourcesFailedToLoad.push({
								source: source,
								status: this._messages.messages.VIT22.code,
								statusText: sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT22.summary)
							});
							log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT22.summary), this._messages.messages.VIT22.code, "sap.ui.vk.GraphicsCore");
							return;
						} else {
							...
							if (!m){
								...
								sourcesFailedToLoad.push({
									source: source,
									status: this._messages.messages.VIT23.code,
									statusText: sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT23.summary)
								});
								log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT23.summary), this._messages.messages.VIT23.code, "sap.ui.vk.GraphicsCore");
								return;
							} else {
								...
								if (originalReferencedSourceUrl.is("relative")) {
									if (source instanceof File) {
										...
										sourcesFailedToLoad.push({
											source: source,
											status: this._messages.messages.VIT24.code,
											statusText: sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT24.summary)
										});
										log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT24.summary), this._messages.messages.VIT24.code, "sap.ui.vk.GraphicsCore");
										return;
									} else {
		...
		if (shadowContentResource.source) {
			...
			if (!dvlSceneDatum) {
				...
				if (shadowContentResource.sourceProperties.version.major >= 4) {
					...
					log.warning(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT20.summary), this._messages.messages.VIT20.code, "sap.ui.vk.GraphicsCore");
				}
			}
	...
	GraphicsCore.prototype.updateSceneTree = function(vkScene, contentResources, onError) {
		...
		if (contentResourcesWithEncryptedVds3.length > 0) {
			log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT25.summary), this._messages.messages.VIT25.code, "sap.ui.vk.GraphicsCore");
			if (onError) {
		...
		if (contentResourcesWithMissingPasswords.length > 0) {
			log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT21.summary), this._messages.messages.VIT21.code, "sap.ui.vk.GraphicsCore");
			if (onError) {
