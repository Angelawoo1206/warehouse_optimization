	...
	Viewport.prototype.getViewInfo = function(query) {
		...
		var getValidatedQuery = function(queryObject) {
			...
			if (!validatedQuery.visibility) {
				...
				if (validatedQuery.visibility.mode !== sap.ui.vk.VisibilityMode.Complete && validatedQuery.visibility.mode !== sap.ui.vk.VisibilityMode.Differences) {
					jQuery.sap.log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT28.summary), this._messages.messages.VIT28.code, "sap.ui.vk.Viewport");
				}
		...
		if (validQuery.camera) {
			...
			if (validQuery.camera.projectionType) {
				viewInfo.camera.projectionType = this._dictionary.encodedProjectionType[this._dvl.Camera.GetProjection(cameraId)];
			...
			if (validQuery.camera.bindingType) {
				viewInfo.camera.bindingType = this._dictionary.encodedBindingType[this._dvl.Camera.GetFOVBinding(cameraId)];
			}
		}
...
//			}
	...
	/**
	 * It retrieves information about the current virtual viewport which is always a square.
	 ...
	 * @returns {object} outputSize The information in this object:
	 <ul>
		<li><b>left</b> - The x coordinate of the top-left corner of the virtual viewport</li>
		<li><b>top</b> - The y coordinate of the top-left corner of the virtual viewport</li>
		<li><b>width</b> - The width of the virtual viewport</li>
		<li><b>height</b> - The height of the virtual viewport</li>
	 </ul>
	 * @public
	 */
	Viewport.prototype.getOutputSize = function() {
		...
		switch (this._dictionary.decodedBindingType[bindingType]) {
	...
	Viewport.prototype.resetView = function(resetOptions) {
		...
		if (resetOptions !== undefined && !jQuery.isPlainObject(resetOptions)) {
			jQuery.sap.log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT31.summary), this._messages.messages.VIT31.code, "sap.ui.vk.Viewport");
		}
