...
sap.ui.define([
	...
	Viewer.prototype.setRuntimeSettings = function(settings) {
		...
		log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT29.summary), this._messages.messages.VIT29.code, "sap.ui.vk.Viewer");
	};
	...
	Viewer.prototype.setWebGLContextAttributes = function(options) {
		...
		log.error(sap.ui.vk.getResourceBundle().getText(this._messages.messages.VIT30.summary), this._messages.messages.VIT30.code, "sap.ui.vk.Viewer");
	};
