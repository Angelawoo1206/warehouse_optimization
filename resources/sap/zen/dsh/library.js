 ...
 */
jQuery.sap.declare("sap.zen.dsh.library");jQuery.sap.require("sap.ui.core.Core");jQuery.sap.require("sap.ui.core.library");jQuery.sap.require("sap.ui.table.library");jQuery.sap.require("sap.ui.layout.library");jQuery.sap.require("sap.m.library");jQuery.sap.require("sap.viz.library");jQuery.sap.require("sap.zen.commons.library");jQuery.sap.require("sap.zen.crosstab.library");sap.ui.getCore().initLibrary({name:"sap.zen.dsh",dependencies:["sap.ui.core","sap.ui.table","sap.ui.layout","sap.m","sap.viz","sap.zen.commons","sap.zen.crosstab"],types:[],interfaces:[],controls:["sap.zen.dsh.Dsh"],elements:[],version:"1.44.3"});
