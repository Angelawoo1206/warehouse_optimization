...
(function () {
    ...
    jQuery.sap.declare("sap.ushell.services.CommonDataModel.PersonalizationProcessor");
     ...
     * @since 1.38.0
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor = function () {};
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._getItemIndex
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._applyAddGroups = function (
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._checkRemoveGroup
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._checkMoveGroup
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._applyMoveGroup = function (
            oOriginalSite, oPersonalizationDelta
    ) {
        var bSuccess = false;
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._getHashedItemsFromSite
     ...
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._getExtractHelperObject
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._extractFromOriginalSiteOneGroup
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._handleItemChangeExtract
    ...
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._extractFromPersonalizedSiteOneGroup
            ...
            aPersonalizedItems.forEach(function (oItem, iIndex) {
                ...
                if ( oExtractHelper.oHashedItemsOriginal[sGroupId]
                    ...
                    if (oMovedTiles[oItem.id]) {
                        // Maybe you should do some sanity test at this point before deleting, but for now simple:
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._cleanupRemovedGroups
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.PersonalizationProcessor.prototype._applyItemChanges
            = function (oOriginalSite, oPersonalizationDelta) {
