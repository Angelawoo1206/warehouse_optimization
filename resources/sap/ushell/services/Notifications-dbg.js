...
(function () {
    ...
    sap.ushell.services.Notifications = function (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        */
        ...
        this._createDummyItems = function (iNumOfItemsToCreate) {
            var index,
                obj,
                tempDate,
                iPriotiyInt,
            ...
            oDummyItems[oOperationEnum.NOTIFICATIONS_BY_DATE_DESCENDING] = [];
            oDummyItems[oOperationEnum.NOTIFICATIONS_BY_DATE_ASCENDING] = [];
            oDummyItems[oOperationEnum.NOTIFICATIONS_BY_PRIORITY_DESCENDING] = [];

            for (index=0 ; index < iNumOfDummyItems; index++) {
                obj =  {
                    "Id": index,
                    "OriginId": "G1Y_800",
                    "IsActionable": true,
                    ...
                    "SensitiveText" :  "Purchase order #" + index,
                    "GroupHeaderText": "",
                    "NotificationCount": 0,
                    "Actor": {
                        "Id": "BAR-LEV",
                        "DisplayText": "BAR-LEV",
                        "ImageSource": "https://scn.sap.com/people/guest/avatar/BAR-LEV.png"
                    },
	                "NavigationTargetParams": [
	                    {
	                        "NotificationId": "00505692-5975-1ED5-ACF1-77645AE4AF3A",
	                        "Key": "PurchaseOrderId",
	                        "Value": "236400"
	                    },
	                    {
                ...
                tempDate = new Date();
                obj.CreatedAt = new Date(tempDate.getTime() - index * 15000);
                iPriotiyInt = parseInt(Math.random() * 3, 10);
                if (iPriotiyInt === 0) {
                    obj.Priority = "LOW";
                    aLowPriority.push(obj);
                } else if (iPriotiyInt === 1) {
                    obj.Priority = "MEDIUM";
                    aMediumPriority.push(obj);
                } else {
                    obj.Priority = "HIGH";
                    aHighPriority.push(obj);                	
                }
                oDummyItems[oOperationEnum.NOTIFICATIONS_BY_DATE_DESCENDING][index] = obj;
                index2 = iNumOfDummyItems-1-index;
                oDummyItems[oOperationEnum.NOTIFICATIONS_BY_DATE_ASCENDING][index2] = obj;
            }
            oDummyItems[oOperationEnum.NOTIFICATIONS_BY_PRIORITY_DESCENDING] = oDummyItems[oOperationEnum.NOTIFICATIONS_BY_PRIORITY_DESCENDING].concat(aHighPriority).concat(aMediumPriority).concat(aLowPriority);
        };
    };
