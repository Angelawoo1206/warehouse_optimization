...
(function () {
    ...
    jQuery.sap.declare("sap.ushell.services.ReferenceResolver");
       ...
       /**
        ...
        this.getValue = function (sReference){
            ...
            if (sReference === "User.env.sap-theme"){
                sValue = sap.ushell.Container.getUser().getTheme(sap.ushell.User.prototype.constants.themeFormat.THEME_NAME_PLUS_URL);
            }
            if (sReference === "User.env.sap-theme-name"){
                sValue = sap.ushell.Container.getUser().getTheme();
            }
            if (sReference === "User.env.sap-theme-NWBC"){
                sValue = sap.ushell.Container.getUser().getTheme(sap.ushell.User.prototype.constants.themeFormat.NWBC);
            }
    ...
    sap.ushell.services.ReferenceResolver = function (oContainerInterface, sParameter, oConfig) {
    ...
    sap.ushell.services.ReferenceResolver.hasNoAdapter = true;
}());
