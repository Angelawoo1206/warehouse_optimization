...
(function () {
    ...
    sap.ushell.services.ClientSideTargetResolution = function (oAdapter, oContainerInterface, sParameters, oServiceConfiguration) {
         ...
         * @since 1.32.0
         */
        this._addDefaultParameterValues = function (oIntentParams, oSignatureParams, oKnownReferenceIn, aMissingReferenceIfMatch, aDefaultedParamNames) {
         ...
         * @since 1.32.0
         */
        this._matchesFilter = function(sValue, oFilter, oKnownReferenceIn, oMissingReferenceOut) {
            var sFilterValue;
         ...
         * @since 1.32.0
         */
        this._addFoundParametersToRefs = function (aReferenceIfMatch, oMissingReferenceOut) {
        ...
        */
         ...
         * @since 1.32.0
         */
        this._matchToInbound = function (oIntent, oInbound, oKnownReferenceIn, oMissingReferenceOut) {
        ...
        function isDYNP_OKCODE_required(oInbound) {
            return oInbound && oInbound.signature && oInbound.signature && oInbound.signature.parameters
             && oInbound.signature.parameters.DYNP_OKCODE && oInbound.signature.parameters.DYNP_OKCODE.required === true; 
        }

        this._adjustDYNP_OKCODE = function(oEffectiveParameters, oMatchingTarget) {
            var that = this;
         ...
         * @since 1.32.0
         */
        this._getMatchingInbounds = function(oShellHash, aInbounds, bExcludeTileInbounds) {
            var that = this,
                oDeferred = new jQuery.Deferred(),
            ...
            var fnResolve = function () {
                ...
                if (bExcludeTileInbounds) {
                    aPreFilteredInbounds = aInbounds.filter(function (oInbound) {
                        ...
                        return !oInbound.tileResolutionResult
                           || !oInbound.tileResolutionResult.isCustomTile;
                    });
                }
                ...
                aPreFilteredInbounds.forEach(function (oInbound) {
                    var oMatchResult = that._matchToInbound(oShellHash, oInbound,
                        {} /* no known references the first time */, oMissingReferences);
            ...
            oReadyToRematchDeferred.done(function (oKnownReferences, aPotentiallyMatchingTargets) {
                fnWhenDebugEnabled(function (bIsDetailedLogging) {
                    jQuery.sap.log.debug(
                        bIsDetailedLogging
                            ? "Rematching with the following resolved user defaults:" + JSON.stringify(oKnownReferences, fnUndefinedReplacer, "   ")
