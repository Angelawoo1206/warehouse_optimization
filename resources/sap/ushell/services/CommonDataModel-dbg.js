...
(function () {
    ...
    sap.ushell.services.CommonDataModel = function (oAdapter, oContainerInterface, sParameters, oServiceConfiguration) {
        jQuery.sap.require("sap.ushell.services.CommonDataModel.PersonalizationProcessor");
        ...
        this._oPersonalizationProcessor = new sap.ushell.services.CommonDataModel.PersonalizationProcessor();
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.prototype.getHomepageGroups = function () {
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.prototype.getGroups = function () {
        var oDeferred = new jQuery.Deferred();
     ...
     * @private
     */
    sap.ushell.services.CommonDataModel.prototype.getGroup = function (sId) {
        var oDeferred = new jQuery.Deferred();
        this._oSitePromise.then(function(oSite) {
     ...
     * @since 1.42.0
     */
    sap.ushell.services.CommonDataModel.prototype.getGroupFromOriginalSite = function (sGroupId) {
        var oDeferred = new jQuery.Deferred();
     ...
     * @since 1.40.0
     */
    sap.ushell.services.CommonDataModel.prototype.save = function () {
        var oDeferred = new jQuery.Deferred(),
            that = this;
