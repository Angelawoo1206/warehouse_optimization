                ...
                return oRecentActivities.recentUsageArray.some(function (oRecentEntry) {
                    ...
                    if (fnEquals(oRecentEntry.oItem, oItem)) {
                        ...
                        if ((oItem.appType === oRecentEntry.oItem.appType) ||
                            (oItem.appType !== sap.ushell.services.AppType.APP)) {
                            ...
                            if ((oItem.appType === oRecentEntry.oItem.appType) ||
                                (oItem.appType !== sap.ushell.services.AppType.APP && oRecentEntry.oItem.appType !== sap.ushell.services.AppType.APP)){
    ...
    sap.ushell.services.UserRecents = function () {
        ...
        oRecentActivity = new RecentActivity(500, function (x, y) {
            if (x.appType === y.appType) {
                if (x.appType !== sap.ushell.services.AppType.APP) {
                    return x.url === y.url;
                } else {
                    return x.appId === y.appId;
                }
            } else {
                if (x.appType === sap.ushell.services.AppType.APP || y.appType === sap.ushell.services.AppType.APP) {
