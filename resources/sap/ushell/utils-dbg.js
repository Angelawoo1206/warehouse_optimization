...
(function () {
     ...
     * @since 1.42.0
     */
    sap.ushell.utils.generateUniqueId = function (vTestCondition) {
        var sUniqueId,
            aExistingIds,
            fnIsUniqueId;
     ...
     *
     */
    sap.ushell.utils.getPrivateEpcm = function () {
    ...
    sap.ushell.utils.isFeatureBitEnabled = function (iFeatureBit) {
        ...
        oPrivateEpcm = sap.ushell.utils.getPrivateEpcm();
        if (oPrivateEpcm) {
            try {
    ...
    sap.ushell.utils._convertToUTC = function (date) {
    ...
    sap.ushell.utils.formatDate = function (sCreatedAt) {
        ...
        iCreatedAt = sap.ushell.utils._convertToUTC(new Date(sCreatedAt));
        iNow = sap.ushell.utils._convertToUTC(sap.ushell.utils._getCurrentDate());
     ...
     * @public
     */
    sap.ushell.utils.moveElementInsideOfAnArray = function (aArray, nIndexOfElement, nNewIdx) {
