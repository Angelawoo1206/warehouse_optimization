...
sap.ui.define(['jquery.sap.global', 'sap/ui/Device', 'sap/ui/core/Control', 'sap/ushell/library',
     ...
     */
        ...
        ShellLayout.prototype.onAfterRendering = function () {
            ...
            this.renderFloatingContainer();
        };
        ShellLayout.prototype.renderFloatingContainer = function () {
            var oContainer = sap.ui.getCore().byId(this.getFloatingContainer()),
            ...
            if (!floatingContainerWrapper){
                ...
                floatingContainerWrapper.setAttribute("class", 'sapUshellShellFloatingContainerWrapper');
            ...
            if (oContainer && !oContainer.getDomRef()) {
                ...
                oContainer.placeAt("sapUshellFloatingContainerWrapper");
            }
        };
