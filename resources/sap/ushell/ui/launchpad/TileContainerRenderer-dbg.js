...
(function () {
    ...
    sap.ushell.ui.launchpad.TileContainerRenderer.render = function (oRm, oControl) {
        ...
        if (aLinks.length > 0) {
            ...
            var lineModeContainer = window.location.search.indexOf("new_links_container=true") !== -1;
            oRm.write("<div");
            var containerClassName = lineModeContainer ? "sapUshellLineModeContainer" : "sapUshellLinksContainer";
            oRm.addClass(containerClassName);
            oRm.writeClasses();
            oRm.write(">");

            if (lineModeContainer) {
