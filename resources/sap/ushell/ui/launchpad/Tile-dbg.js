 ...
 * <li>{@link #getPinButton pinButton} : sap.ui.core.Control[]</li></ul>
 * </li>
 * <li>Associations
 * <ul></ul>
 * </li>
 ...
 * @return {sap.ui.core.Control[]}
 * @public
 * @name sap.ushell.ui.launchpad.Tile#getPinButton
 * @function
 */


/**
 * Inserts a pinButton into the aggregation named <code>pinButton</code>.
 *
 * @param {sap.ui.core.Control}
 *          oPinButton the pinButton to insert; if empty, nothing is inserted
 * @param {int}
 *             iIndex the <code>0</code>-based index the pinButton should be inserted at; for 
 *             a negative value of <code>iIndex</code>, the pinButton is inserted at position 0; for a value 
 *             greater than the current size of the aggregation, the pinButton is inserted at 
 *             the last position        
 * @return {sap.ushell.ui.launchpad.Tile} <code>this</code> to allow method chaining
 * @public
 * @name sap.ushell.ui.launchpad.Tile#insertPinButton
 * @function
 */

/**
 * Adds some pinButton <code>oPinButton</code> 
 * to the aggregation named <code>pinButton</code>.
 *
 * @param {sap.ui.core.Control}
 *            oPinButton the pinButton to add; if empty, nothing is inserted
 * @return {sap.ushell.ui.launchpad.Tile} <code>this</code> to allow method chaining
 * @public
 * @name sap.ushell.ui.launchpad.Tile#addPinButton
 * @function
 */

/**
 * Removes an pinButton from the aggregation named <code>pinButton</code>.
 *
 * @param {int | string | sap.ui.core.Control} vPinButton the pinButton to remove or its index or id
 * @return {sap.ui.core.Control} the removed pinButton or null
 * @public
 * @name sap.ushell.ui.launchpad.Tile#removePinButton
 * @function
 */

/**
 * Removes all the controls in the aggregation named <code>pinButton</code>.<br/>
 * Additionally unregisters them from the hosting UIArea.
 * @return {sap.ui.core.Control[]} an array of the removed elements (might be empty)
 * @public
 * @name sap.ushell.ui.launchpad.Tile#removeAllPinButton
 * @function
 */

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation named <code>pinButton</code> 
 * and returns its index if found or -1 otherwise.
 *
 * @param {sap.ui.core.Control}
 *            oPinButton the pinButton whose index is looked for.
 * @return {int} the index of the provided control in the aggregation if found, or -1 otherwise
 * @public
 * @name sap.ushell.ui.launchpad.Tile#indexOfPinButton
 * @function
 */
	

/**
 * Destroys all the pinButton in the aggregation 
 * named <code>pinButton</code>.
 * @return {sap.ushell.ui.launchpad.Tile} <code>this</code> to allow method chaining
 * @public
 * @name sap.ushell.ui.launchpad.Tile#destroyPinButton
 * @function
 */
...
(function () {
    ...
    sap.ushell.ui.launchpad.Tile.prototype.onfocusin = function (oEvent) {
    ...
    sap.ushell.ui.launchpad.Tile.prototype._initDeleteAction = function () {
        ...
        if (!this.deleteIcon) {
            ...
            this.deleteIcon.addCustomData(new sap.ushell.ui.launchpad.AccessibilityCustomData({
                key: "aria-label",
