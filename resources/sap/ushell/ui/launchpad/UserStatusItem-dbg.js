...
sap.ui.define(['jquery.sap.global', 'sap/ushell/library'],
    function (jQuery, ManagedObject) {
            ...
            renderer: {
                renderLIContent : function (rm, oContainer) {
                    ...
                    if (!oContainer.getIsOpener()) {
                        oContainer.addCustomData(new sap.ushell.ui.launchpad.AccessibilityCustomData({
                            key: "tabindex",
                            value: "0",
                            writeToDom: true
                        }));
        ...
        UserStatusItem.prototype.STATUS_ENUM = {
            ...
            APPEAR_OFFLINE  : {text: translationBundle.getText("userStatus_appearOffline"), id: 3, styleClass: "sapUshellUserStatusAppearOfflineIndicator", status: "AppearOffline"},
