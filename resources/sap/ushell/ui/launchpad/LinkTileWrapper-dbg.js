...
(function () {
    ...
    sap.ushell.ui.launchpad.LinkTileWrapper.prototype._launchTileViaKeyboard = function (oEvent) {
        if (oEvent.target.tagName !== "BUTTON") {
            ...
            if (oTileUIWrapper.firePress) {
                ...
                this.triggerClickEvent(oTileUIWrapper);
    ...
    sap.ushell.ui.launchpad.LinkTileWrapper.prototype.triggerClickEvent = function (oClickedObj) {
        ...
        oClickedObj.getDomRef().dispatchEvent(oClickEvent);
    };
