...
(function () {
    ...
    sap.ushell.ui.launchpad.TileRenderer.renderTileView = function (oRm, oTileView, oPinButton, sTarget) {
        if ((sTarget || "") !== "") {
            oRm.write("<a");
            oRm.writeClasses();
    ...
    sap.ushell.ui.launchpad.TileRenderer.renderTileActionMode = function (oRm, oControl) {
