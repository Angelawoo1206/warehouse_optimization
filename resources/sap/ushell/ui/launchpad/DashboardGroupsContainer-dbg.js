 ...
 * <li>{@link #getDisplayMode displayMode} : string</li></ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
sap.ui.core.Control.extend("sap.ushell.ui.launchpad.DashboardGroupsContainer", { metadata : {
	...
	properties : {
		...
		/**
		 */
		"displayMode" : {type : "string", group : "", defaultValue : null}
	},
	aggregations : {
...
/**
 * Getter for property <code>displayMode</code>.
 *
 * Default value is empty/<code>undefined</code>
 *
 * @return {string} the value of property <code>displayMode</code>
 * @public
 * @name sap.ushell.ui.launchpad.DashboardGroupsContainer#getDisplayMode
 * @function
 */

/**
 * Setter for property <code>displayMode</code>.
 *
 * Default value is empty/<code>undefined</code> 
 *
 * @param {string} sDisplayMode  new value for property <code>displayMode</code>
 * @return {sap.ushell.ui.launchpad.DashboardGroupsContainer} <code>this</code> to allow method chaining
 * @public
 * @name sap.ushell.ui.launchpad.DashboardGroupsContainer#setDisplayMode
 * @function
 */
