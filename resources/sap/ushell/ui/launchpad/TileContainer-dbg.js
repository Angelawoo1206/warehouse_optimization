 ...
 *
 * @param {int | string | sap.ui.core.Control} vLink the link to remove or its index or id
 * @return {sap.ui.core.Control} the removed link or null
 * @public
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation named <code>links</code> 
 * and returns its index if found or -1 otherwise.
 *
 * @param {sap.ui.core.Control}
...
(function () {
    ...
    sap.ushell.ui.launchpad.TileContainer.prototype.setShowGroupHeader = function (bVisible) {
    ...
    sap.ushell.ui.launchpad.TileContainer.prototype.handleScreenReaderAttr = function () {
