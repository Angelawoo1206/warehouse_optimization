            ...
            if (firstResult) {
                ...
                for (i = 0; i < itemattributes.length; i++) {
                    if (itemattributes[i].indexInTable !== undefined && itemattributes[i].key !== undefined) {
                        ...
                        // key dosn't have special character
                        if (key === escape(key).replace(/[^\w\s]/gi, '')) {
                            // push table columns
                            columns.push({
                            ...
                            that.pushError({
                                type: "warning",
                                title: sap.ushell.resources.i18n.getText("keyOfAttributeHasForbiddenCharacters"),
                                description: sap.ushell.resources.i18n.getText("keyOfAttributeHasForbiddenCharactersDetail", key)
                            });
                        }
                    }
                }
