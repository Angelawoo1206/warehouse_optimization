...
(function () {
     ...
     * @private
     */
    sap.ushell.renderers.fiori2.Renderer.prototype.showRightFloatingContainerItem = function (aIds, bCurrentState, aStates) {
        if (typeof aIds === "string") {
     ...
     * @private
     */
    sap.ushell.renderers.fiori2.Renderer.prototype.showSignOutItem = function (bCurrentState, aStates) {
     ...
     *   if false, add the Settings button to the LaunchPadState itself.
     *
     * @param {String[]} aStates
     *   (only valid if bCurrentState is set to false) - list of the sap.ushell.renderers.fiori2.renderer.LaunchpadState in which to add the aIds.
     *
     ...
     * @private
         */
    sap.ushell.renderers.fiori2.Renderer.prototype.showSettingsItem = function (bCurrentState, aStates) {
     ...
     * @public
     */
    sap.ushell.renderers.fiori2.Renderer.prototype.setFooterControl = function (controlType, oControlProperties) {
...
/*--------------------------Hide ----------------------------------*/
     ...
     * @public
     */
    sap.ushell.renderers.fiori2.Renderer.prototype.addActionButton = function (controlType, oControlProperties, bIsVisible, bCurrentState, aStates, bIsFirst) {
        var fnCreate = function (oControlProperties) {
                var ViewPrototype;
...
/*---------------Conditional----------------*/
    sap.ushell.renderers.fiori2.Renderer.prototype.createInspection = function (sAttibute, aCheckPoint, bCurrentState, aStates) {
        this.oShellModel.createInspection(sAttibute, aCheckPoint, bCurrentState, aStates);
    };

    sap.ushell.renderers.fiori2.Renderer.prototype.createTriggers = function (aTriggers, bCurrentState, aStates) {
        this.oShellModel.createTriggers(aTriggers, bCurrentState, aStates);
    };

/*---------------Generic--------------------*/
    sap.ushell.renderers.fiori2.Renderer.prototype.convertButtonsToActions = function (aIds, bCurrentState, aStates, bIsFirst){
        var oProperties = {},
            oButton,
            that = this;
