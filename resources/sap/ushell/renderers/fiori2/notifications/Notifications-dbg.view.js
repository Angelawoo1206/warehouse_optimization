        ...
        createContent: function (oController) {
            ...
            this.triggerRetrieveMoreData = function (path) {
                if (!this.getModel().getProperty("/" + path + "/inUpdate")) {
                    ...
                    if (listItem.getDomRef() && jQuery(listItem.getDomRef()).offset().top <= topOffSet) {
            ...
            this.oIconTabBar = new sap.m.IconTabBar('notificationIconTabBar', {
                ...
                select: function (evt) {
                    ...
                    } else if (key === "sapUshellNotificationIconTabByType") {
                        if (that.oPreviousTabKey !== "sapUshellNotificationIconTabByType") {
