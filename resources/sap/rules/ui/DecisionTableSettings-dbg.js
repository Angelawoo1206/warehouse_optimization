...
sap.ui.define([
	...
	function(jQuery, library, Control, SimpleForm, Label, Switch, Select, Table, Text, CheckBox, Input, ExpressionAdvanced, VerticalLayout, ExpressionType) {
		"use strict";
		...
		// sap.rules.ui.DecisionTableSettings.prototype.exit = function() {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createDecisionTable = function(oData, mParameters) {
			var oModel = this._getModel();
			var oContext = this.getBindingContext();
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createRow = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createCondition = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createCellsForNewColumn = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createCellsForNewRow = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createResult = function(oData, mParameters) {

			var oContext = this.getBindingContext();
			
			// FIXME: use ResultDataObjectId instead
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._createResultParameter = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._removeColumn = function(oColumnContext, mParameters) {
			var oModel = this._getModel();
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._removeCellsForColumn = function(oData, mParameters) {
			var oModel = this._getModel();
			var oContext = this.getBindingContext();
			var rowKeys = oModel.getProperty("DecisionTable/DecisionTableRows", oContext);
		...
		sap.rules.ui.DecisionTableSettings.prototype._setFixedOperatorOnExpressionChange = function(displayExpression, colId) {
		...
		sap.rules.ui.DecisionTableSettings.prototype._getColumnControlObject = function(oBindingContext) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._prepareNewRuleWorkaround = function() {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._addConditionWorkaround = function(oData, mParameters) {
		 ...
		 * @private
		 */
		sap.rules.ui.DecisionTableSettings.prototype._removeColumnWorkaround = function(oColumnContext, mParameters) {
			var oModel = this._getModel();
		 ...
		 *  @param {map} mParameters? - Optional parameter map containing any of the following properties:
		 */
		sap.rules.ui.DecisionTableSettings.prototype._saveWorkaround = function(mParameters) {
			var oModel = this._getModel();
			oModel.submitChanges(mParameters);
		};


		sap.rules.ui.DecisionTableSettings.prototype._getModel = function() {
		...
		sap.rules.ui.DecisionTableSettings.prototype._getAdvancedModeData = function() {
			var mode;
		...
		sap.rules.ui.DecisionTableSettings.prototype._getFixedOperatorDataForExpression = function(sExpression) {
		...
		sap.rules.ui.DecisionTableSettings.prototype._setAdvancedMode = function(oControlEvent) {
