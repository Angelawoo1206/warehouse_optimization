...
sap.ui.define([
    ...
    */
    var ExpressionBasic = ExpressionBase.extend("sap.rules.ui.ExpressionBasic", {
        ...
        _onChangeByIndex: function (instructionIndex) {
			...
			this._removeFurtherInstructions(instructionIndex);
            ...
            //we'll update only the right part, might be 2 instructions at "in_between" or duration
				suggestions = expressionLanguage._getBasicSuggestions(updatedExpression,suggestionsPart.rightPart);
            }
