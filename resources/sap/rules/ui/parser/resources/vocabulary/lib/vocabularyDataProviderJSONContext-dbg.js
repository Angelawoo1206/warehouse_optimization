...
sap.rules.ui.parser.resources.vocabulary.lib.vocabularyDataProviderJSONContext.lib = (function() {
	 ...
	 * Constructor
	 *--------------------------------------------------------------------*/
	function vocaDataProviderJSONContextLib(resourceContent, resourceID) {
		//In ABAP and 'Client' modes (i.e JSON mode) the vocabulary resource given in oData format,
		//therefore we need to convert it into HRF internal schema format.  
		var convertedVoca = resourcesConvertor.convertVocabularyODataToInternalModel(resourceContent);
