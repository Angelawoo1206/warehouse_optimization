...
sap.rules.ui.parser.resources.vocabulary.lib.vocabularyDataProviderContextFactory.lib = (function() {
	...
	function getRTSContextJSON(inputParamObj){	
		...
		var rtsContextJSONInstance = new vocabularyDataProviderJSONContext.vocaDataProviderJSONContextLib(inputParamObj.resourceContent, inputParamObj.resourceID);
