...
sap.rules.ui.parser.ruleBody.lib.ruleServices.lib = (function(){
	 ...
	 * @param flags
	 */
	var validateDecisionTableExpression = function (headerExpression, fixedOperator, cellExpression, businessDataType, vocabulary, vocaDataProvider, flags) {
		...
		var result = decisionTableCell.validateAndConvert(flags);
