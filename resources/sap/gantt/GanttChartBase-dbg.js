	...
	var GanttChartBase = Control.extend("sap.gantt.GanttChartBase", /** @lends sap.gantt.GanttChartBase.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 * configuration is provided.
				 */
				modes: {type: "sap.gantt.config.Mode[]", defaultValue: sap.gantt.config.DEFAULT_MODES},
				 ...
				 */
				toolbarSchemes: {type: "sap.gantt.config.ToolbarScheme[]", defaultValue: sap.gantt.config.DEFAULT_GANTTCHART_TOOLBAR_SCHEMES},
				 ...
				 */
				hierarchies: {type: "sap.gantt.config.Hierarchy[]", defaultValue: sap.gantt.config.DEFAULT_HIERARCHYS},
				 ...
				 */
				objectTypes: {type: "sap.gantt.config.ObjectType[]", defaultValue: sap.gantt.config.DEFAULT_OBJECT_TYPES},
				 ...
				 */
				chartSchemes: {type: "sap.gantt.config.ChartScheme[]", defaultValue: sap.gantt.config.DEFAULT_CHART_SCHEMES},
				 ...
				 */
				shapes: {type: "sap.gantt.config.Shape[]", defaultValue: []}
			},
