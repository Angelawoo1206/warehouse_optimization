	...
	var HierarchyColumn = Element.extend("sap.gantt.config.HierarchyColumn", /** @lends sap.gantt.config.HierarchyColumn.prototype */ {
		metadata: {
			properties: {
				 ...
				 */
				attributes: {type: "sap.gantt.config.ColumnAttribute[]", defaultValue: []}, //optional. array of objects. new file columnAttribute to describe object: object type, attribute
				/**
				 * Column Width
				 */
