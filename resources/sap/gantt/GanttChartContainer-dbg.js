	...
	var GanttChartContainer = Control.extend("sap.gantt.GanttChartContainer", /** @lends sap.gantt.GanttChartContainer.prototype */ {
		metadata: {
			...
			properties: {
				 ...
				 */
				toolbarSchemes: {type: "sap.gantt.config.ToolbarScheme[]", defaultValue: sap.gantt.config.DEFAULT_CONTAINER_TOOLBAR_SCHEMES},
				 ...
				 */
				containerLayouts: {type: "sap.gantt.config.ContainerLayout[]", defaultValue: sap.gantt.config.DEFAULT_CONTAINER_LAYOUTS},
