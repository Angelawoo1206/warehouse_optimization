			...
			if (eventObj) {
                ...
                if (this.element) {
                    ...
                    if (this.layoutDetails) {
                        if (this.startX - elemLeft < this.resizeHandleDistance || (elemLeft + elemWidth - this.startX) < this.resizeHandleDistance ||
                            this.startY - elemTop < this.resizeHandleDistance || (elemTop + elemHeight - this.startY) < this.resizeHandleDistance) {
                            this.isResize = true;
                        }
                    } else {
