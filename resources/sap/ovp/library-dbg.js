...
/**
 * Initialization Code and shared classes of library sap.ovp (1.44.6)
 */
...
if (sap.ui.Device.browser.firefox) {
    jQuery.sap.log.warning("Loading library 'sap.viz' to avoid issues with Firefox sync XHR support (https://bugzilla.mozilla.org/show_bug.cgi?id=697151)");
