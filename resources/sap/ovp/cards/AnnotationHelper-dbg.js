	...
	function _formatField(iContext, oItem, oEntityType, oMetaModel, bDontIncludeUOM, bIncludeOnlyUOM, bUseSimplePath) {
        ...
        if (!bIncludeOnlyUOM) {
            ...
            if (oEntityTypeProperty["type"] === 'Edm.DateTime' || oEntityTypeProperty["type"] === 'Edm.DateTimeOffset') {
                ...
                var iScale = (oItem.ValueFormat && oItem.ValueFormat.NumberOfFractionalDigits) ? oItem.ValueFormat.NumberOfFractionalDigits.Int : 0,
                    sUnitPath = oEntityTypeProperty["sap:unit"],
                    oUnitProperty = sUnitPath ? oMetaModel.getODataProperty(oEntityType, sUnitPath) : null,
                ...
                } else if (oUnitProperty && oUnitProperty["sap:semantics"] === "currency-code") {
                    functionName = getCurrencyFormatFunctionName(iScale);
